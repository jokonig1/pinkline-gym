...
const HORARIOS = [
  { dia: 'Lunes',     mañana: '06:00 – 11:00', tarde: '18:00 – 21:00' },
  { dia: 'Martes',    mañana: '06:00 – 11:00', tarde: '18:00 – 21:00' },
  { dia: 'Miércoles', mañana: '06:00 – 11:00', tarde: '18:00 – 21:00' },
  { dia: 'Jueves',    mañana: '06:00 – 11:00', tarde: '18:00 – 21:00' },
  { dia: 'Viernes',   mañana: '06:00 – 11:00', tarde: '18:00 – 21:00' },
  { dia: 'Sábado',    mañana: '06:00 – 11:00', tarde: '—' },
]
    ...
    <div className="min-h-screen" style={{ background: '#fff', color: '#111' }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-zinc-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          <a href="#inicio" className="shrink-0">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/imagenes pinkline/Pinkline.svg" alt="Pinkline" className="h-16 sm:h-20 w-auto object-contain" />
          </a>
      ...
      <section id="nosotras" className="py-24 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="text-[10px] font-bold uppercase tracking-[3px] text-pink-500 mb-4">Sobre nosotras</div>
              ...
              <a href={waLink} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-pink-500 font-bold text-sm hover:text-pink-600 transition-colors mt-6">
      ...
      <section id="servicios" className="py-24 px-4 bg-zinc-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <div className="text-[10px] font-bold uppercase tracking-[3px] text-pink-500 mb-4">Servicios</div>
      ...
      <section id="planes" className="py-24 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <div className="text-[10px] font-bold uppercase tracking-[3px] text-pink-500 mb-4">Planes y precios</div>
      ...
      <section className="py-24 px-4 bg-zinc-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[10px] font-bold uppercase tracking-[3px] text-pink-500 mb-4">Experiencias</div>
      ...
      <section id="horarios" className="py-24 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[10px] font-bold uppercase tracking-[3px] text-pink-500 mb-4">Horarios</div>
            <h2 className="text-3xl sm:text-4xl font-black text-zinc-900">Nos adaptamos a tu rutina</h2>
            <p className="text-zinc-500 mt-3 text-sm">
              Consulta disponibilidad por WhatsApp. Buscamos el horario que mejor se adapte a ti.
            </p>
          </div>

          <div className="bg-white border border-zinc-100 rounded-2xl overflow-hidden shadow-sm">
            <div className="grid grid-cols-3 bg-zinc-50 border-b border-zinc-100 px-5 py-3">
              <div className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Día</div>
              <div className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Mañana</div>
              <div className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Tarde</div>
            </div>
            {HORARIOS.map((h, i) => (
              <div key={h.dia}
                className={`grid grid-cols-3 px-5 py-3.5 border-b border-zinc-50 last:border-b-0 ${i % 2 !== 0 ? 'bg-pink-50/40' : ''}`}>
                <div className="text-sm font-bold text-zinc-900">{h.dia}</div>
      ...
      <section id="contacto" className="py-24 px-4 bg-zinc-100">
        <div className="max-w-4xl mx-auto text-center">
          <div className="text-[10px] font-bold uppercase tracking-[3px] text-pink-500 mb-4">Contacto</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
            ...
            <div className="bg-white border border-zinc-100 rounded-2xl p-6 text-center hover:border-pink-200 transition-colors">
            ...
            <div className="bg-white border border-zinc-100 rounded-2xl p-6 text-center hover:border-pink-200 transition-colors">
              ...
              <a href={waLink} target="_blank" rel="noopener noreferrer"
                className="text-sm font-medium text-zinc-700 hover:text-pink-500 transition-colors">
                {WHATSAPP}
              </a>
            </div>
